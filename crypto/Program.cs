...
encryptorShamilA.Encrypt("t.jpg");
encryptorShamilB.Encrypt("ShamirEnc_t.jpg");
encryptorShamilA.Decrypt("ShamirEnc_ShamirEnc_t.jpg");
encryptorShamilB.Decrypt("ShamirDec_ShamirEnc_ShamirEnc_t.jpg");